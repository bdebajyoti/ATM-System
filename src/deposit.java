...
public class deposit extends javax.swing.JFrame {
    ...
    private void Bal()
    {
        String sql="select bal from customer_acc where card='"+welcome.getText()+"'";
        try
        {
...
private void Show()
{
    ...
    private void initComponents() {
        ...
        setSize(new java.awt.Dimension(541, 519));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        bal=bal+Double.parseDouble(d.getText());
        String sql="update customer_acc set deposit='"+d.getText()+"',bal='"+bal+"' where card ='"+welcome.getText()+"'";
        try
        {
